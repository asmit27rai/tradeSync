...
import { GetPriceResponse, ISlinky, ISLINKY_PRECOMPILE_ADDRESS } from "../precompiles/ISlinky.sol";
import { FutureByIdResponse, IAsync, IASYNC_PRECOMPILE_ADDRESS } from "../precompiles/IAsync.sol";
